    ...
    <div>
      <div className="min-h-screen bg-black text-white">
        ...
        <nav className="flex items-center justify-center p-3">
          <div className="flex items-center bg-[#232323] border border-gray-700 p-2 rounded-md">
        ...
        <div className="text-center mt-20 px-4">
          <span className="bg-gray-800/50 border-2 border-indigo-200 border-l-[#5f62ff] border-t-indigo-500 border-r-[#9d82e3] border-b-[#7a47ff] text-sm px-6 py-2 rounded-full">
        ...
        {/* Features Grid */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6 p-8 max-w-7xl mx-auto">
          {/* Easy Integration */}
          <div className="bg-gray-900/50 p-6 rounded-xl col-span-2">
